...
const TopNavigation: React.FC<TopNavigationProps> = ({ toggleSidebar, isToggleButtonVisible = true }) => {
    return (
        <>
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mt-2 mt-lg-0">
                            ...
                            <li className="nav-item"><Link className="nav-link" to="/introduction">Introduction</Link></li>
                            <li className="nav-item"><Link className="nav-link" to="/character">Build a character</Link></li>
                            ...
                            <li className="nav-item"><Link className="nav-link" to="/learn-to-play">Learn to play</Link></li>
                            <li className="nav-item"><Link className="nav-link" to="/items">Items</Link></li>
                            <li className="nav-item"><Link className="nav-link" to="/spells">Spells</Link></li>
